...
/**
 * KafkaAccountUtil class provides utility methods for sending messages to the Kafka topic.
 */
@Slf4j
@Component
@RequiredArgsConstructor
public class KafkaAccountUtil {

  private final KafkaTemplate<String, GenericEvent> kafkaTemplate;

  @Value("${kafka.nttbank.topic.producers[0]}")
